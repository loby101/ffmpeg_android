...
#define FFMPEG_CONFIGURATION "--prefix=/android/project/ffmpeg/android/arm --enable-shared --enable-static --disable-doc --disable-programs --enable-small --disable-avdevice --disable-devices --disable-protocols --enable-protocol=file --enable-cross-compile --cross-prefix=/android/tools/android-ndk-r10e/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --sysroot=/android/tools/android-ndk-r10e/platforms/android-16/arch-arm/ --extra-cflags='-Os -fpic' --extra-ldflags= --arch=arm --target-os=android"
